/**
 * SmartAIReduction页面 - 智能降AI页面
 * 通过智能语义重组，提升论文的人类撰写感，降低AI检测率
 */
import { useState } from 'react'
import { useNavigate } from 'react-router-dom'
import AuthModal from '../components/AuthModal'
import { streamReduceAI } from '../api/essay'

/**
 * SmartAIReduction页面主函数组�? * @returns 智能降AI页面布局
 */
function SmartAIReduction() {
  ...
  const handleStartAIReduction = async () => {
    ...
    try {
      const generator = streamReduceAI({
    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="h-14 bg-white border-b border-gray-200 flex items-center px-6">
          <h1 className="text-lg font-semibold text-gray-800">智能降AI</h1>
        ...
        <div className="flex-1 p-6 overflow-y-auto">
          <div className="max-w-6xl mx-auto">
            {/* 降AI工具标题 */}
            <div className="mb-6">
              <h2 className="text-xl font-bold text-gray-800 mb-2">降AI率工具</h2>
            ...
            <div className="flex justify-end mb-4 space-x-3">
              ...
              <button
                onClick={handleStartAIReduction}
              ...
              >
                ...
                <span>{isProcessing ? '降AI中...' : '开始降AI'}</span>
              </button>
            </div>
                  ...
                  <div className="p-4 min-h-[480px] flex flex-col justify-center items-center">
                    {resultText ? (
                      ...
                      <div className="flex flex-col items-center space-y-3">
                        ...
                        <span className="text-gray-500">正在降AI中...</span>
                      </div>
                    ) : (
...
export default SmartAIReduction
